                        ...
                        if (!dropElement) {
                            ...
                            if (tmpMatch) {
                                ...
                                if ('!1' == tmpValue) {
                                    ...
                                    const prefix = '${q=' + tmpValue + ',!1===q||"string"!=typeof q&&("number"!=typeof q||isNaN(q))?!0!==q?``:`';
                        ...
                        if (!dropElement) {
                            ...
                            if (attributes[attribute] && jTDAL._regexpCondition.exec(attributes[attribute][3])) {
                                ...
                                if ('!0' == tmpValue) {
                                    ...
                                    const invertTernary = tmpValue.startsWith('!c(') && !tmpValue.includes('||');
                                    const omitTagPrefix = invertTernary ? `\${${tmpValue.substring(1)}?\`` : `\${${tmpValue}?\`\`:\``;
                                    const omitTagSuffix = invertTernary ? '`' + ':``}' : '`}';
                                    if (repeatName) {
